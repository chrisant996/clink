...
/* begin_clink_change */
extern int rl_add_history (int, int);
/* end_clink_change */
...
/* begin_clink_change */
extern int rl_remove_history (int, int);
/* end_clink_change */
...
/* begin_clink_change */
extern int rl_backward_old_menu_complete (int, int);
/* end_clink_change */
...
/* begin_clink_change */
extern int rl_is_insert_next_callback_pending (void);
/* end_clink_change */
...
#define MATCH_TYPE_MASK			0x0007
#define MATCH_TYPE_LINK			0x0010
#define MATCH_TYPE_ORPHANED		0x0020
...
extern rl_vccpfunc_t *rl_override_match_append;
/* end_clink_change */
