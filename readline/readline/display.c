...
/* begin_clink_change */
      ...
      invis_addc (&out, '*', _rl_face_modmark);
/* end_clink_change */
      invis_nul (&out);
      modmark = 1;
    }
...
/* begin_clink_change */
      if (rl_get_face_func)
	cur_face = rl_get_face_func (in, hl_begin, hl_end);
      else
/* end_clink_change */
      if (in == hl_begin)
...
/* begin_clink_change */
	  inv_face[lmargin] = _rl_face_horizscroll;
/* end_clink_change */
	}
      ...
      if (t > 0 && t < out)
	{
	  invisible_line[t - 1] = '>';
/* begin_clink_change */
	  inv_face[t - 1] = _rl_face_horizscroll;
/* end_clink_change */
	}
...
/* begin_clink_change */
  if (rl_puts_face_func)
    {
      rl_puts_face_func (str, face, n);
      return;
    }
/* end_clink_change */
