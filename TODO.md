...
- Make `clink update` able to consider it a success case when already up to date?  This is a Design Change Request -- that's simply not how the command was designed to be used (it probably should have been, but it wasn't).  See [comment in #441](https://github.com/chrisant996/clink/issues/441#issuecomment-1740322341).
