...
- Wildcard completion commands similar to bash:
...
- Expansion commands similar to bash:
  - [x] `shell-expand-line` (M-C-e) Perform alias, history, and environment variable expansion on the current line.
  - [x] `history-expand-line` (M-^) Perform history expansion on the current line.
  - [x] `alias-expand-line` () A synonym for `clink-expand-doskey-alias`.
  - [x] `history-and-alias-expand-line` () Perform history and alias expansion on the current line.
- Another synonym:
  - [x] `insert-last-argument` (M-. or M-_) A synonym for `yank-last-arg`.
