...
## Normal Priority
- Classifiers and :chaincommand() don't play well together.  :chaincommand() shifts the line_state, and classifiers after _argmatcher priority see shifted line_states.
