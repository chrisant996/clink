...
public:
    typedef FARPROC     funcptr_t;
                        pe_info(void* base);
    funcptr_t*          get_import_by_name(const char* dll, const char* func_name, str_base* found_in_module=nullptr) const;
    funcptr_t*          get_import_by_addr(const char* dll, funcptr_t func_addr, str_base* found_in_module=nullptr) const;
...
private:
    ...
    funcptr_t*          iterate_imports(const char* dll, const void* param, import_iter_t iter_func, str_base* found_in_module) const;
    void*               m_base;
