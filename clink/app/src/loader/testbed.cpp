...
//------------------------------------------------------------------------------
int testwrap(int argc, char** argv)
{
    static const char* help_usage = "Usage: testwrap [options]\n";
    ...
    while ((i = getopt_long(argc, argv, "?h", options, nullptr)) != -1)
    {
        ...
        default:
            ...
            puts("Options:");
            puts_help(help);
            puts("This runs some diagnostic data collection about some terminal host behaviors.");
            return ret;
        }
    }
