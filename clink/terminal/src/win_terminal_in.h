...
public:
    ...
    virtual bool    send_terminal_request(const char* request, const char* response_prefix, const char* response_final, str_base& out, uint32 timeout1, uint32 timeout2) override;
