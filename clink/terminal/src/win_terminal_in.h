...
public:
    ...
    virtual bool    send_terminal_request(const char* request, const char* response_prefix, const char* response_final, uint32 timeout1, uint32 timeout2, str_base& out) override;
