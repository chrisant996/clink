...
int32 mk_wcswidth(const char32_t *pwcs, size_t n)
{
  int32 w, width = 0;
 ...
 */
int32 mk_wcwidth_cjk(char32_t ucs)
{
...
int32 mk_wcswidth_cjk(const char32_t *pwcs, size_t n)
{
  int32 w, width = 0;
...
int32 test_ambiguous_width_char(char32_t ucs)
{
