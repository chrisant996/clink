...
/* end_clink_change */
  ...
  { "vi-back-to-indent", rl_vi_back_to_indent, keycat_cursor, "" },
  { "vi-backward-bigword", rl_vi_bWord, keycat_cursor, "" },
  { "vi-backward-word", rl_vi_bword, keycat_cursor, "" },
  ...
  { "vi-column", rl_vi_column, keycat_cursor, "" },
  { "vi-complete", rl_vi_complete, keycat_completion, "" },
  { "vi-delete", rl_vi_delete, keycat_basic, "" },
  ...
  { "vi-end-bigword", rl_vi_eWord, keycat_cursor, "" },
  { "vi-end-word", rl_vi_end_word, keycat_cursor, "" },
  { "vi-eof-maybe", rl_vi_eof_maybe, keycat_misc, "" },
  { "vi-eword", rl_vi_eword, keycat_cursor, "" },
  //{ "vi-fWord", rl_vi_fWord },	/* BEWARE: name matching is case insensitive */
  { "vi-fetch-history", rl_vi_fetch_history, keycat_history, "" },
  { "vi-first-print", rl_vi_first_print, keycat_cursor, "" },
  { "vi-forward-bigword", rl_vi_fWord, keycat_cursor, "" },
  { "vi-forward-word", rl_vi_fword, keycat_cursor, "" },
  //{ "vi-fword", rl_vi_fword },	/* BEWARE: name matching is case insensitive */
  { "vi-goto-mark", rl_vi_goto_mark, keycat_misc, "" },
  { "vi-insert-beg", rl_vi_insert_beg, keycat_basic, "" },
  { "vi-insertion-mode", rl_vi_insert_mode, keycat_basic, "" },
  { "vi-match", rl_vi_match, keycat_misc, "" },
  { "vi-movement-mode", rl_vi_movement_mode, keycat_basic, "" },
  { "vi-next-word", rl_vi_next_word, keycat_cursor, "" },
  { "vi-overstrike", rl_vi_overstrike, keycat_misc, "" },
  { "vi-overstrike-delete", rl_vi_overstrike_delete, keycat_misc, "" },
  { "vi-prev-word", rl_vi_prev_word, keycat_cursor, "" },
  ...
  { "vi-tilde-expand", rl_vi_tilde_expand, keycat_completion, "" },
  ...
  { "vi-yank-arg", rl_vi_yank_arg, keycat_history, "" },
