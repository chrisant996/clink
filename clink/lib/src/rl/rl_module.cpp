...
, m_prev_group(-1)
{
    ...
    if (!s_rl_initialized)
    {
        ...
        clink_add_funmap_entry("clink-copy-word", clink_copy_word, keycat_misc, "Copies the word at the cursor to the clipboard");
        clink_add_funmap_entry("clink-copy-cwd", clink_copy_cwd, keycat_misc, "Copies the current working directory to the clipboard");
        clink_add_funmap_entry("clink-expand-env-var", clink_expand_env_var, keycat_misc, "Expands environment variables in the word at the cursor");
        ...
        clink_add_funmap_entry("clink-up-directory", clink_up_directory, keycat_misc, "");
        clink_add_funmap_entry("clink-insert-dot-dot", clink_insert_dot_dot, keycat_misc, "");
        clink_add_funmap_entry("clink-scroll-line-up", clink_scroll_line_up, keycat_scroll, "Scroll the terminal display up one line");
        clink_add_funmap_entry("clink-scroll-line-down", clink_scroll_line_down, keycat_scroll, "Scroll the terminal display down one line");
        clink_add_funmap_entry("clink-scroll-page-up", clink_scroll_page_up, keycat_scroll, "Scroll the terminal display up one page");
        clink_add_funmap_entry("clink-scroll-page-down", clink_scroll_page_down, keycat_scroll, "Scroll the terminal display down one page");
        clink_add_funmap_entry("clink-scroll-top", clink_scroll_top, keycat_scroll, "Scroll to the top of the terminal display");
        clink_add_funmap_entry("clink-scroll-bottom", clink_scroll_bottom, keycat_scroll, "Scroll to the bottom of the terminal display");
        clink_add_funmap_entry("clink-popup-complete", clink_popup_complete, keycat_completion, "");
        clink_add_funmap_entry("clink-popup-history", clink_popup_history, keycat_history, "");
        clink_add_funmap_entry("clink-popup-directories", clink_popup_directories, keycat_misc, "");
        clink_add_funmap_entry("clink-popup-show-help", clink_popup_show_help, keycat_misc, "");
        clink_add_funmap_entry("clink-find-conhost", clink_find_conhost, keycat_misc, "");
        clink_add_funmap_entry("clink-mark-conhost", clink_mark_conhost, keycat_misc, "");
        clink_add_funmap_entry("clink-complete-numbers", clink_complete_numbers, keycat_completion, "");
        clink_add_funmap_entry("clink-menu-complete-numbers", clink_menu_complete_numbers, keycat_completion, "");
        clink_add_funmap_entry("clink-menu-complete-numbers-backward", clink_menu_complete_numbers_backward, keycat_completion, "");
        clink_add_funmap_entry("clink-old-menu-complete-numbers", clink_old_menu_complete_numbers, keycat_completion, "");
        clink_add_funmap_entry("clink-old-menu-complete-numbers-backward", clink_old_menu_complete_numbers_backward, keycat_completion, "");
        clink_add_funmap_entry("clink-popup-complete-numbers", clink_popup_complete_numbers, keycat_completion, "");
        ...
        clink_add_funmap_entry("cua-backward-char", cua_backward_char, keycat_select, "");
        clink_add_funmap_entry("cua-forward-char", cua_forward_char, keycat_select, "");
        clink_add_funmap_entry("cua-backward-word", cua_backward_word, keycat_select, "");
        clink_add_funmap_entry("cua-forward-word", cua_forward_word, keycat_select, "");
        clink_add_funmap_entry("cua-beg-of-line", cua_beg_of_line, keycat_select, "");
        clink_add_funmap_entry("cua-end-of-line", cua_end_of_line, keycat_select, "");
        clink_add_funmap_entry("cua-copy", cua_copy, keycat_select, "");
        clink_add_funmap_entry("cua-cut", cua_cut, keycat_select, "");
