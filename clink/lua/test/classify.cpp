...
TEST_CASE("Lua word classification.")
{
    ...
    SECTION("Main")
    {
        ...
        SECTION("Flags not flag")
        {
            ...
            tester.set_expected_classifications("cfao");
            tester.run();
        }
        ...
        SECTION("Flags unrecognized flag")
        {
            ...
            tester.set_expected_classifications("cfoa");
            tester.run();
        }
        ...
        SECTION("Flags unrecognized arg")
        {
            ...
            tester.set_expected_classifications("cfon");
            tester.run();
        }
        ...
        SECTION("Flags not linked")
        {
            ...
            tester.set_expected_classifications("cffafnf");
            tester.run();
        }
