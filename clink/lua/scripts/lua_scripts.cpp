...
"local _argnode = {}\n"
"_argnode.__index = _argnode\n"
"setmetatable(_argnode, { __call = function (x, ...) return x._new(...) end })\n"
"function _argnode._new(candidate, forward_list)\n"
"    return setmetatable({\n"
"        _is_func = (type(candidate) == \"function\"),\n"
"        _candidate = candidate,\n"
"        _forward_list = forward_list,\n"
"    }, _argnode)\n"
"end\n"
"function _argnode:equals(word, ...)\n"
"    -- Does this node generate candidates that match word?\n"
"    for _, candidate in ipairs(self:getwords(...)) do\n"
"        -- Extract the correct candidate from match descriptions.\n"
...
"    return false\n"
"end\n"
"function _argnode:getwords(...)\n"
"    if self._is_func then\n"
"        words = self._candidate(...)\n"
"        if type(words) ~= \"table\" then\n"
"            error(\"Argmatcher functions must return a table\")\n"
"        end\n"
"        return words\n"
"    end\n"
"    return { tostring(self) }\n"
"end\n"
"function _argnode:__tostring()\n"
"    local t = type(self._candidate)\n"
"    if t == \"string\" then\n"
"        return self._candidate\n"
"    end\n"
"    if t == \"table\" then\n"
"        return self._candidate.match or \"<unknown>\"\n"
"    end\n"
"    return \"<\" .. t .. \">\"\n"
"end\n"
"local _argmatcher = {}\n"
...
"    -- Promote the next pending list to an active one.\n"
"    local list = self._pending_list\n"
"    list._active = true\n"
"    -- Create a new pending list hook the new list to it.\n"
"    self._pending_list = { _matcher = self }\n"
"    list._next_list = self._pending_list\n"
"    self:_add(list, {...})\n"
"    table.insert(self._args, list)\n"
"    return self\n"
"end\n"
"function _argmatcher:addflags(...)\n"
"    self._flags = self._flags or clink:argmatcher()\n"
"    self._flags:addarg({...})\n"
"    return self\n"
"end\n"
...
"    return self\n"
"end\n"
"function _argmatcher:generatefiles(enabled)\n"
...
"        return _argnode(lhs, rhs._args[1])\n"
"    end\n"
"    if t == \"table\" then\n"
"        local ret = {}\n"
...
"        return ret\n"
"    end\n"
"    error(\"Left-hand side must be a string or function\", 2)\n"
"end\n"
"function _argmatcher:__call(arg)\n"
"    if type(arg) ~= \"table\" then\n"
"        error(\"Arguments to shorthand matchers must be tables\")\n"
"    end\n"
"    if #arg then\n"
"        local first_char = tostring(arg[1]):sub(1,1)\n"
...
"    return false\n"
"end\n"
"function _argmatcher:_add(list, node)\n"
"    -- Flatten out tables unless the table is an already-created node\n"
"    local is_node = (getmetatable(node) == _argnode)\n"
"    if type(node) == \"table\" and not is_node and not node.match then\n"
"        for _, i in ipairs(node) do\n"
"            self:_add(list, i)\n"
"        end\n"
"        return\n"
"    end\n"
"    -- Convert the argument option into a node if it isn't one.\n"
"    if not is_node then\n"
"        node = _argnode(node, self._pending_list)\n"
"    end\n"
...
"    local word_index = 2\n"
"    local list = self._args[1]\n"
"    local function traverse_list(exact)\n"
"        -- Special case where we've reached a link to an empty matcher. Return\n"
"        -- false to indicate that all match generation should stop.\n"
"        if list == nil then\n"
"            return false\n"
"        end\n"
"        -- Have we reached the end of the road? Either loop or stop traversal.\n"
"        if not list._active then\n"
"            local matcher = list._matcher\n"
"            if matcher._loop then\n"
"                local loop_index = math.max(math.min(matcher._loop, #matcher._args), 1)\n"
"                list = matcher._args[loop_index]\n"
"            else\n"
"                return true\n"
"            end\n"
"        end\n"
"        -- The active list is the one that provides the matches if there's only\n"
"        -- one word left to consume.\n"
"        if word_index >= word_count then\n"
"            return true\n"
"        end\n"
"        -- See if we can find the current word in the list we're traversing.\n"
"        local word = line_state:getword(word_index)\n"
"        if not word then print(\"!!\"..tostring(word_index)) end\n"
"        for _, node in ipairs(list) do\n"
"            if node:equals(word, word_index, line_state) then\n"
"                word_index = word_index + 1\n"
"                list = node._forward_list\n"
"                return traverse_list()\n"
"            end\n"
"        end\n"
"        if exact then\n"
"            list = list._next_list\n"
"            return true\n"
"        end\n"
"        -- Always check the current matcher's flags.\n"
"        local matcher = list._matcher\n"
"        if matcher._flags and matcher:_is_flag(word) then\n"
"            local prev_list = list\n"
"            list = matcher._flags._args[1]\n"
"            if not traverse_list(true) then\n"
"                return false\n"
"            end\n"
"            if list._active then\n"
"                return true\n"
"            end\n"
"            list = prev_list\n"
"            return traverse_list()\n"
"        end\n"
"        -- No matches at all so simply move onto our next list and consume \n"
"        -- another word.\n"
"        word_index = word_index + 1\n"
"        list = list._next_list\n"
"        return traverse_list()\n"
...
"        return true\n"
"    end\n"
"    -- Look for flag matches in the words left to consume.\n"
"    local matcher = list._matcher or self\n"
"    if not list._active and matcher._flags then\n"
"        while word_index < word_count do\n"
"            local word = line_state:getword(word_index)\n"
"            if matcher:_is_flag(word) then\n"
"                list = matcher._flags._args[1]\n"
"                traverse_list(true)\n"
"            end\n"
"            word_index = word_index + 1\n"
"        end\n"
"    end\n"
"    -- We should always add flags as matches because they're not positional.\n"
"    matcher = list._matcher\n"
"    if matcher._flags then\n"
"        for _, node in ipairs(matcher._flags._args[1]) do\n"
"            local matches = node:getwords(word_index, line_state)\n"
...
"        end\n"
"    end\n"
"    -- If we reached an inactive list then we're not generating matches.\n"
"    if not list._active then\n"
"        return self._no_file_generation -- 'return false' means _do_ files!\n"
"    end\n"
"    -- If we got this far then 'list' contains our candidate matches.\n"
"    for _, node in ipairs(list) do\n"
"        local matches = node:getwords(word_index, line_state)\n"
...
"    -- Create a new argmatcher object.\n"
"    local matcher = {}\n"
"    matcher._args = {}\n"
"    matcher._pending_list = { _matcher = matcher }\n"
"    setmetatable(matcher, _argmatcher);\n"
"    matcher:setflagprefix(\"-\")\n"
"    -- Extract priority from the arguments.\n"
"    matcher._priority = 999\n"
"    local input = {...}\n"
"    if #input and type(input[1]) == \"number\" then\n"
...
"    { 'four', 'five' }\n"
"    { 'nine', 'ten', 'eleven' }\n"
"    { '-flag' .. clink:argmatcher() { 'red', 'green', 'blue'}, '-guff' }\n"
