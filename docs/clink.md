...
-|-
<a name="configactiveregionendcolor"></a>`active-region-end-color` | Not used or needed in Clink.
<a name="configactiveregionstartcolor"></a>`active-region-start-color` | TODO: DOCUMENT.
...
<a name="configenableactiveregion"></a>`enable-active-region` | TODO: DOCUMENT.
